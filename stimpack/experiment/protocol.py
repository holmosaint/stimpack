...
class LinearTrackWithWalls(BaseProtocol):
    """
    Linear track with walls.
    """
    def __init__(self, cfg):
        super().__init__(cfg)
    ...
    def get_epoch_parameters(self):
        ...
        wall_height = 0.5
        left_wall = {'name':  'CheckerboardWall',
                'mean': self.epoch_protocol_parameters['wall_color_mean'],
                'contrast': self.epoch_protocol_parameters['track_color_contrast'],
                'center': (0, track_length * n_repeat_track / 2, track_z_level),
                'side_length': (track_width, track_length * n_repeat_track, wall_height),
                'patch_width': track_patch_width}
        
        self.epoch_stim_parameters.append(left_wall)
        
        right_wall = {'name':  'CheckerboardWall',
                'mean': self.epoch_protocol_parameters['wall_color_mean'],
                'contrast': self.epoch_protocol_parameters['track_color_contrast'],
                'center': (0, track_length * n_repeat_track / 2, track_z_level),
                'side_length': (-track_width, track_length * n_repeat_track, wall_height),
        ...
        self.epoch_stim_parameters.append(right_wall)
        
        
        # trackZ = {'name':  'CheckerboardFloorZ',
        #     'mean': self.epoch_protocol_parameters['track_color_mean'],
        #     'contrast': self.epoch_protocol_parameters['track_color_contrast'],
        #     'center': (0, track_length * n_repeat_track / 2, track_z_level),
        #     'side_length': (track_width, track_length * n_repeat_track),
        ...
        # # self.epoch_stim_parameters.append(trackZ)
        # self.epoch_stim_parameters = [trackZ]
    ...
    def get_protocol_parameter_defaults(self):
        return {'pre_time': 1.0,
                ...
                'wall_color_mean': 1, # brightness of wall (track_color_mean: for floor)
